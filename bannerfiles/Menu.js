...
function PrepContents(oMaster)
{
	...
	oMaster._wzChkMrkPath="_layouts/images/ChkMrk.html";
	oMaster._wzMArrPath="_layouts/images/MArr.html";
	oMaster._wzMArrPathRtL="_layouts/images/MArrRtL.html";
}
...
function CreateMenuOption(oMaster, oRow, oNode, wzID, wzHtml)
{
	...
	else
	{
		if (browseris.nav || oMaster._fLargeIconMode)
		{
			...
			var wzIconId=wzID+"_"+"ICON";
			oImg.id=wzIconId;
			oImg.src="_layouts/images/blank.html";
			oImg.alt="";
			oImg.title="";
			oImgLbl.htmlFor=wzIconId;
			oImgLbl.appendChild(oMenuItemBody);
