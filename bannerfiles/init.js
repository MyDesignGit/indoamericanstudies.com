function Browseris () {
	...
	if (this.nav6up)
	{
		var navIdx=agt.indexOf("netscape/index.html");
		if (navIdx >=0 )
	...
	{
		var navIdx=agt.indexOf("safari/index.html");
		if (navIdx >=0)
...
{
	if (url.substr(0, 4) !="http" && url.substr(0,1) !="index.html")
	{
...
function UrlContainsIllegalStrings(strPath)
{
	if(strPath.indexOf("..") >=0
		|| strPath.indexOf("http://") >=0
		|| strPath.indexOf("index.html") >=0
		|| strPath.indexOf("/.") >=0
		|| strPath.indexOf(".")==0
...
function GetUrlFromWebUrlAndWebRelativeUrl(webUrl, webRelativeUrl)
{
	...
	if (retUrl.charAt(retUrl.length - 1) !="index.html")
	{
		retUrl+="index.html";
	}
...
function ShowHideSection(sectionid, imgid)
{
	...
	if (group.style.display !="none")
	{
		...
		img.src="_layouts/images/plus.html";
	}
	else
	{
		group.style.display="";
		img.src="_layouts/images/minus.html";
	}
}
	...
	if (g_PNGImageIds !=null && useFilter)
	{
		for (var i=0; i < g_PNGImageIds.length; i++)
		{
			...
			if (img !=null && g_PNGImageSources[i] !=null)
			{
				...
				img.src="_layouts/images/blank.html";
			}
		}
	}
}
...
function retrieveCurrentThemeLink()
{
	...
	if(cssLink)
	{
		...
		var newURL=relativeURL.replace(re, "index.html");
		return newURL;
	}
}
...
JSRequest={
	...
	EnsureSetup : function()
	{
		...
		var p=path.lastIndexOf("index.html");
		if (p > -1)
		{
...
function ExpCollGroup(groupName, imgName)
{
	...
	if (img==null)
		return;
	srcPath=img.src;
	index=srcPath.lastIndexOf("index.html");
	imgName=srcPath.slice(index+1);
	var fOpen=false;
	if (imgName=='plus.html')
	{
		fOpen=true;
		displayStr="";
		img.src='_layouts/images/minus.html';
	...
	for (var i=0;i<numElts;i++)
	{
					...
					&& (groupName==childObj.id.slice(4).substr(0,len)) )
		{
			...
			if (fOpen && childObj.id.substr(0,4)=="titl")
			{
				...
				imgObj.src='_layouts/images/plus.html';
			}
		}
	}
...
function IMNGetStatusImage(state, showoffline)
{
	...
	switch (state)
	{
		...
		break;
		case 19:
			img="imnidlebusy.html";
			alt=L_IMNBusy_Text;
		break;
		case 20:
			img="imnidlebusyoof.html";
			alt=L_IMNBusy_OOF_Text;
		break;
	}
...
function IMNUpdateImage(id, imgInfo)
{
	...
	if (obj)
	{
		...
		var alt=imgInfo.alt;
		var oldImg=obj.src;
		var index=oldImg.lastIndexOf("index.html");
		var newImg=oldImg.slice(0, index+1);
		newImg+=img;
		if (oldImg==newImg && img !='blank.html')
			return;
		if (obj.altbase)
		{
			obj.alt=obj.altbase;
		...
		if (useFilter)
		{
			if (isPng)
			{
				...
				obj.src="_layouts/images/blank.html";
			}
			else
			{
				obj.style.filter="";
